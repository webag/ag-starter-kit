...
<section>
	<div class="container">
		...
		<a href="#" class="fancy-modal btn anim" data-src="#modal-order">Открыть order</a>
		<a href="#" class="fancy-modal btn anim" data-src="#modal-order">Открыть order</a>
		<a href="img/img.png" class="fancy btn anim" data-fancybox="1">Открыть img</a>
		<a href="img/img.png" class="fancy btn anim" data-fancybox="1">Открыть img</a>
		<a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" class="fancy-video btn anim">Открыть youtube</a>
		<a href="https://yandex.ru/map-widget/v1/-/CBQneLhsOA" class="fancy-map btn anim">схема проезда</a>
